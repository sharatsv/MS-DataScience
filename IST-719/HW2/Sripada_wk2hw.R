...
dev.new()
par(mfrow = c(2,2))
# Q1: Correlation between unit.price and units.sold
...
# A1: The bar-chart shows a linear increase in the units sold as the unit.price increases 
# until a certain point. Then there is an exponential drop with increased units sold
# for drawing journal (24.94).
# Hence there is no clear relationship between unit.price and number of units sold.


######################################################################################

# Q2: Sold more of drawing paper or watercolor paper
draw <- art[art$paper == 'drawing', ]
...
# A2: From the visualization Watercolor sold more units

######################################################################################

# Q3: Does drawing paper or watercolor have more sales 
...
# A3:From the visualization Watercolor has more sales 
